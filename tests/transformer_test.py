...
from simple_lstm import AbstractTransformer, DataPreprocessor, DataScaler
...
if __name__ == '__main__':
    ...
    features = np.cos(x_linspace)
    features = features.reshape((-1, 1))

    data_preprocessors = DataPreprocessor([ ShiftTransformer(0.3),AbsTransformer(),
                                           DataScaler()])
